...
public class parent_child_track extends Activity {
	 ProgressDialog pd;
			...
			// register.setText("My Queries");
				    ...
				    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {  
		                public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {  
		                     ...
		                     Log.i("id", arrSplit[0]);  
		                     Toast.makeText(parent_child_track.this,arrSplit[0].trim() ,Toast.LENGTH_LONG);
		                     id=arrSplit[0].trim();
		                     Intent i = new Intent(parent_child_track.this,user_location_view_1.class); 	 
							 startActivity(i);
		                }  
		           });	
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	 ...
	 public void commonRequestThread() {
	    ...
	    public void commonRequest()
	    {
	        ...
	        HttpPost httppost = new HttpPost("http://"+MainActivity.ip+"/emergency_list.php");
	        InputStream is = null;
	        String result = "";
	        try {
	            // Add your data
